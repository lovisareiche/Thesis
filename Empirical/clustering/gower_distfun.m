...
load minmax.mat % pre-saved vectors for minimum and maximum values of the p variables, must be saved outside this function depending on the variables the clustering occurs on
